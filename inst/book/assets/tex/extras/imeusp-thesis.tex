...
%     }{%
%       This is the original version of the \@IMElowercase{\workname} prepared
%       by candidate \@author, as submitted to the Examining Committee.%
%     }%
%   }%
%   \renewcommand\@finalFrontmatterText{%
%     This version of the \@IMElowercase{\workname} includes the corrections
...
\DTMsavedate{@defensedate}{2023-01-05}
\providecommand\@program{Estatística}
\providecommand\@financing{}
\providecommand\@defenselocation{São Paulo}
\providecommand\@license{CC-BY 4.0}
\providecommand\@title{Resolvendo Captchas}
\providecommand\@titlept{Resolvendo Captchas}
\providecommand\@titleen{Solving Captchas}
\providecommand\@resumo{Resumo}
\providecommand\@abstract{Resumo}
