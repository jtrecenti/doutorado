...
% LaTeX oferece desde sempre 2 pares de comandos nativos para mudar textos
% para caixa alta ou baixa: \uppercase, \lowercase, \MakeUppercase e
% \MakeLowecase, mas esses comandos têm algumas limitações importantes
% (https://tug.org/TUGboat/tb41-1/tb127wright-case.pdf ). Por muito tempo,
% o recomendado era usar os comandos \MakeTextUppercase e \MakeTextLowercase
% da package textcase, mas os comandos abaixo, disponíveis em versões mais
% recentes de LaTeX, são mais robustos.
%
...
\csappto{input@path}{{assets/tex/extras/}}
