...
# Motivação {background-image="./assets/img/dados_tjmg.jpeg" background-size="200px" background-repeat="repeat" background-opacity="0.1"}
...
- Problema da LAI: esforço e formato dos dados: transparência passiva.
- __Solução__: disponibilizar dados de forma aberta: transparência ativa
...
## Queremos resolver Captchas? {auto-animate=true}
...
# Estado da arte {background-image="./assets/img/dados_tjmg.jpeg" background-size="200px" background-repeat="repeat" background-opacity="0.1"}
...
# Nova abordagem {background-image="./assets/img/dados_tjmg.jpeg" background-size="200px" background-repeat="repeat" background-opacity="0.1"}
...
- Combina __raspagem de dados__ e __aprendizado fracamente supervisionado__
...
- Modelo inicial: pode ser ajustado com uma base completamente anotada
- Também pode ser um super-modelo generalista
...
# Simulação {background-image="./assets/img/dados_tjmg.jpeg" background-size="200px" background-repeat="repeat" background-opacity="0.1"}
...
- Aplicação iterada do WAWL para verificar melhorias contínuas
...
# Resultados {background-image="./assets/img/dados_tjmg.jpeg" background-size="200px" background-repeat="repeat" background-opacity="0.1"}
...
# Conclusões {background-image="./assets/img/dados_tjmg.jpeg" background-size="200px" background-repeat="repeat" background-opacity="0.1"}

## Principais avanços {.center .center-x}
...
## Principais contribuições {.center .center-x}
